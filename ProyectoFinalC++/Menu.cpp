...
int main(){
	...
	//do{
		...
		cout <<"20 - Programa que Permite ingresar 20 Notas acumulandolo en un Vector\n";
		cout <<"21 - Salir del programa principal\n";
		cout <<"/////////////////////////////////////////////////////////////////////////////////////////////////////////////\n\n";
		...
		switch(opcion){
			...
			case 20: cout<<endl; system("EjerArreglo"); system("cls"); system("Menu");break;
			
			case 21: cout<<endl; cout<<"Ha salido del programa"; exit(0); break;
